...
class LessonCardAction extends StatefulWidget {
  final Function changeTab;
  final TabController menu;
  final Lesson lesson;
  final Function refreshLessons;

  const LessonCardAction({
    super.key,
  ...
  @override
  _LessonCardActionState createState() => _LessonCardActionState();
}

class _LessonCardActionState extends State<LessonCardAction> {
